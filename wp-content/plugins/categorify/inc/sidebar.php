...
class Categorify_Sidebar
{
    ...
    public function categorifyScripts()
    {
        ...
        wp_add_inline_script( 'inline-script-handle-header', '/* <![CDATA[ */ var categorifyFolders = [{"folderID":"all","folderName":"' . esc_html( $allFilesText ) . '"}, {"folderID":"-1","folderName":"' . esc_html( $uncategorizedText ) . '"},' . wp_kses_post( substr( $attachmentTerms, 2 ) ) . ']; /* ]]> */' );
