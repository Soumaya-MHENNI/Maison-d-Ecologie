 ...
 *
 */
if ( ! class_exists( 'FERS_Abstract' ) ) {
  abstract class FERS_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        FERS::$css = apply_filters( "fers_{$this->unique}_output_css", FERS::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'FERS_Field_' . $field_type;
