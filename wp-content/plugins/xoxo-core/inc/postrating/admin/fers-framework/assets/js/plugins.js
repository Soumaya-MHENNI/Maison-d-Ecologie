...
* MIT License
*
* Customized by Forhad
*
*/
(function($) {

  function FERSAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  FERSAjaxChosen.prototype.init = function() {
  ...
  FERSAjaxChosen.prototype.events = function() {
  ...
  FERSAjaxChosen.prototype.search_field_focused = function() {
  ...
  FERSAjaxChosen.prototype.search_welcome_message = function() {
  ...
  FERSAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('fers-chosen', _this.options.data).done( function( response ) {
  ...
  FERSAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.fers-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.FERSChosenOrder($hidden_value, true);
  ...
  $.fn.FERSAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new FERSAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, FERSAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  FERSAbstractChosenOrder = (function() {

    function FERSAbstractChosenOrder() {}

    FERSAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    FERSAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    FERSAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    FERSAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    FERSAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    FERSAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    FERSAbstractChosenOrder.FERSChosenOrder = function(select, order, force) {
    ...
    return FERSAbstractChosenOrder;
  ...
  $.fn.extend({
    FERSChosenOrder: function(order, force) {
      return _FERSChosenOrder.FERSChosenOrder(this, order, force);
    }
  });

  this._FERSChosenOrder = (function(_super) {
    __extends(_FERSChosenOrder, _super);

    function _FERSChosenOrder() {
      _ref = _FERSChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _FERSChosenOrder.relAttributeName = 'data-option-array-index';

    _FERSChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _FERSChosenOrder.getDOMElement = function(element) {
    ...
    _FERSChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _FERSChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _FERSChosenOrder;

  })(FERSAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('fers-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Forhad: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Forhad: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectFERS = FormSerializer.serializeObject;
    $.fn.serializeJSONFERS   = FormSerializer.serializeJSON;
  }
