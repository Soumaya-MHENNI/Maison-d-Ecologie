 ...
 *
 */
if ( ! class_exists( 'FERS_Field_sortable' ) ) {
  class FERS_Field_sortable extends FERS_Fields {
    ...
    public function render() {
      ...
      echo '<div class="fers-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="fers-sortable-item">';

          echo '<div class="fers-sortable-content">';
          ...
          FERS::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="fers-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
