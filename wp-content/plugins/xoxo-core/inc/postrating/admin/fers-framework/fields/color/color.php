 ...
 *
 */
if ( ! class_exists( 'FERS_Field_color' ) ) {
  class FERS_Field_color extends FERS_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="fers-color"'. $default_attr . $this->field_attributes() .'/>';
