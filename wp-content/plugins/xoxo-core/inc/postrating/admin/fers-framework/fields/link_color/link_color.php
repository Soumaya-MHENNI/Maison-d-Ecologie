 ...
 *
 */
if ( ! class_exists( 'FERS_Field_link_color' ) ) {
  class FERS_Field_link_color extends FERS_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'xoxo-core' ),
        'hover'    => esc_html__( 'Hover', 'xoxo-core' ),
        'active'   => esc_html__( 'Active', 'xoxo-core' ),
        'visited'  => esc_html__( 'Visited', 'xoxo-core' ),
        'focus'    => esc_html__( 'Focus', 'xoxo-core' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if ( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="fers--left fers-field-color">';
          echo '<div class="fers--title">'. esc_attr( $color_prop_value ) .'</div>';
          echo '<input type="text" name="'. esc_attr( $this->field_name( '['. $color_prop_key .']' ) ) .'" value="'. esc_attr( $value[$color_prop_key] ) .'" class="fers-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';
