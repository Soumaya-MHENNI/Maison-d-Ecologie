 ...
 * @since 0.1
 */
class Xoxo_Social extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'xoxo_social', // Base ID
			esc_html__( 'Frenify Social', 'xoxo-core' ), // Name
			array( 'description' => esc_html__( 'Social Icons', 'xoxo-core' ), ) // Args
		);
		
		add_action( 'widgets_init', function() {
            register_widget( 'Xoxo_Social' );
        });
	}
	...
	function widget( $args, $instance ) {
		...
		$title 		= apply_filters(esc_html__('Subscribe & Follow', 'xoxo-core'), $title );
		...
		?>
           	<div class="xoxo_fn_widget_social">
				<ul>
					<?php
						if($facebook != ''){echo '<li><a href="'.$facebook.'">'.$facebook_icon.'</a></li>';}
						if($twitter != ''){echo '<li><a href="'.$twitter.'">'.$twitter_icon.'</a></li>';}
						if($pinterest != ''){echo '<li><a href="'.$pinterest.'">'.$pinterest_icon.'</a></li>';}
						if($linkedin != ''){echo '<li><a href="'.$linkedin.'">'.$linkedin_icon.'</a></li>';}
						if($behance != ''){echo '<li><a href="'.$behance.'">'.$behance_icon.'</a></li>';}
						if($vimeo != ''){echo '<li><a href="'.$vimeo.'">'.$vimeo_icon.'</a></li>';}
						if($google != ''){echo '<li><a href="'.$google.'">'.$google_icon.'</a></li>';}
						if($youtube != ''){echo '<li><a href="'.$youtube.'">'.$youtube_icon.'</a></li>';}
						if($instagram != ''){echo '<li><a href="'.$instagram.'">'.$instagram_icon.'</a></li>';}
						if($github != ''){echo '<li><a href="'.$github.'">'.$github_icon.'</a></li>';}
						if($flickr != ''){echo '<li><a href="'.$flickr.'">'.$flickr_icon.'</a></li>';}
						if($dribbble != ''){echo '<li><a href="'.$dribbble.'">'.$dribbble_icon.'</a></li>';}
						if($dropbox != ''){echo '<li><a href="'.$dropbox.'">'.$dropbox_icon.'</a></li>';}
						if($paypal != ''){echo '<li><a href="'.$paypal.'">'.$paypal_icon.'</a></li>';}
						if($picasa != ''){echo '<li><a href="'.$picasa.'">'.$picasa_icon.'</a></li>';}
						if($soundcloud != ''){echo '<li><a href="'.$soundcloud.'">'.$soundcloud_icon.'</a></li>';}
						if($whatsapp != ''){echo '<li><a href="'.$whatsapp.'">'.$whatsapp_icon.'</a></li>';}
						if($skype != ''){echo '<li><a href="'.$skype.'">'.$skype_icon.'</a></li>';}
						if($slack != ''){echo '<li><a href="'.$slack.'">'.$slack_icon.'</a></li>';}
						if($rocketchat != ''){echo '<li><a href="'.$rocketchat.'">'.$rocketchat_icon.'</a></li>';}
						if($telegram != ''){echo '<li><a href="'.$telegram.'">'.$telegram_icon.'</a></li>';}
						if($vkontakte != ''){echo '<li><a href="'.$vkontakte.'">'.$vkontakte_icon.'</a></li>';}
						if($rss != ''){echo '<li><a href="'.$rss.'">'.$rss_icon.'</a></li>';}
					?>
				</ul>
            </div>
	...
	function form( $instance ) {
		...
		$title 			= ! empty( $instance['title'] ) ? $instance['title'] : esc_html__('Subscribe & Follow', 'xoxo-core');
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'facebook' )); ?>"><?php echo $facebook_icon; esc_html_e('Facebook', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter' )); ?>"><?php echo $twitter_icon; esc_html_e('Twitter', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'pinterest' )); ?>"><?php echo $pinterest_icon; esc_html_e('Pinterest', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'linkedin' )); ?>"><?php echo $linkedin_icon; esc_html_e('Linkedin', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'behance' )); ?>"><?php echo $behance_icon; esc_html_e('Behance', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'vimeo' )); ?>"><?php echo $vimeo_icon; esc_html_e('Vimeo', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'google' )); ?>"><?php echo $google_icon; esc_html_e('Google', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'youtube' )); ?>"><?php echo $youtube_icon; esc_html_e('Youtube', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'instagram' )); ?>"><?php echo $instagram_icon; esc_html_e('Instagram', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'github' )); ?>"><?php echo $github_icon; esc_html_e('Github', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr' )); ?>"><?php echo $flickr_icon; esc_html_e('Flickr', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'dribbble' )); ?>"><?php echo $dribbble_icon; esc_html_e('Dribbble', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'dropbox' )); ?>"><?php echo $dropbox_icon; esc_html_e('Dropbox', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'picasa' )); ?>"><?php echo $picasa_icon; esc_html_e('Picasa', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'soundcloud' )); ?>"><?php echo $soundcloud_icon; esc_html_e('Soundcloud', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'whatsapp' )); ?>"><?php echo $whatsapp_icon; esc_html_e('Whatsapp', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'skype' )); ?>"><?php echo $skype_icon; esc_html_e('Skype', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'slack' )); ?>"><?php echo $slack_icon; esc_html_e('Slack', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'wechat' )); ?>"><?php echo $wechat_icon; esc_html_e('Wechat', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'icq' )); ?>"><?php echo $icq_icon; esc_html_e('ICQ', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'rocketchat' )); ?>"><?php echo $rocketchat_icon; esc_html_e('Rocketchat', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'telegram' )); ?>"><?php echo $telegram_icon; esc_html_e('Telegram', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'vkontakte' )); ?>"><?php echo $vkontakte_icon; esc_html_e('Vkontakte', 'xoxo-core'); ?></label>
		...
		<p class="xoxo_fn_social_paragraph">
			<label for="<?php echo esc_attr($this->get_field_id( 'rss' )); ?>"><?php echo $rss_icon; esc_html_e('RSS', 'xoxo-core'); ?></label>
